...
{
    public partial class UC_ApplicationItems : UserControl
    {
        public UC_ApplicationItems()
        {
            InitializeComponent();
        }
        ...
        private void imageAppli_Click(object sender, EventArgs e)
        {
            //UC_Application_Page AP = new UC_Application_Page();
            //CLs_Application_info cls = new CLs_Application_info();
            this.NameApp 
